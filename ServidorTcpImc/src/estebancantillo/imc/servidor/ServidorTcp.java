...
//La clase representa un servidor TCP multihilo que escucha en un puerto específico y acepta conexiones de clientes.
public class ServidorTcp extends Thread {
    ...
    //Con este metodo intentamos abrir un ServerSocket en el puerto especificado y actualiza la interfaz gráfica con el estado y mensajes del servidor.
    ...
    //Con este metodo cerramos los sockets de todos los clientes conectados y actualiza la interfaz gráfica con el estado y mensajes del servidor. 
    public void detenerServicio() {
        if (estado) {
            ...
            try {
                ...
                System.out.println("ERRROR no se puede cerrar el Puerto "
                        + puerto);
                String msg = log() + "ERRROR no se puede cerrar el Puerto "
                        + puerto;
                System.out.println(msg);
                ventana.getCajaLog().append(msg + "\n");
            }
    ...
    //Creamos un string con la fecha y hora actual en formato para los mensajes de log.
    public String log() {
